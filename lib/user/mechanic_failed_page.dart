...
class MechanicFailedPage extends StatefulWidget {
  const MechanicFailedPage({super.key, required, required this. id, required this.name });
  final id;
  final name;
...
class _MechanicFailedPageState extends State<MechanicFailedPage> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(future: FirebaseFirestore.instance.collection("Request").doc(widget.id).get(),
